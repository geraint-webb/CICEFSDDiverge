...
! 2019 Elizabeth Hunke
      ...
      character (len=max_nstrm), public :: &
           ...
           f_dafsd_weld = 'm', f_dafsd_nils = 'h', f_wave_sig_ht = 'm', & !GW
      ...
      namelist / icefields_fsd_nml /    &
           ...
           f_dafsd_weld, f_dafsd_nils, f_wave_sig_ht, &
           f_aice_ww   , f_diam_ww    , &
           f_hice_ww   , f_fsdrad     , &
           f_fsdperim
...
! author:   Elizabeth C. Hunke, LANL
      ...
      use ice_arrays_column, only: wave_sig_ht, floe_rad_c, floe_binwidth, &
         d_afsd_newi, d_afsd_latg, d_afsd_latm, d_afsd_wave, d_afsd_weld,d_afsd_nils
